...
void PQCLEAN_NAMESPACE_gf256v_set_zero(uint8_t *b, unsigned _num_byte) {
...
///
uint8_t PQCLEAN_NAMESPACE_gf16v_get_ele(const uint8_t *a, unsigned i) {
    uint8_t r = a[i >> 1];
    uint8_t r0 = r & 0xf;
    uint8_t r1 = r >> 4;
...
/// @return  the value of the element.
///
static uint8_t PQCLEAN_NAMESPACE_gf16v_set_ele(uint8_t *a, unsigned i, uint8_t v) {
...
void PQCLEAN_NAMESPACE_gf16mat_mul(uint8_t *c, const uint8_t *a, const uint8_t *b, unsigned len_vec) {
...
unsigned gf16mat_solve_linear_eq_ref(uint8_t *sol, const uint8_t *inp_mat, const uint8_t *c_terms, unsigned n) {
    ...
    unsigned r8 = PQCLEAN_NAMESPACE_gf16mat_gauss_elim(mat, n, n + 2);  /// XXX: this function is ``defined'' in blas.h
    for (unsigned i = 0; i < n; i++) {
...
unsigned PQCLEAN_NAMESPACE_gf16mat_inv(uint8_t *inv_a, const uint8_t *a, unsigned H, uint8_t *buffer) {
    ...
    unsigned r8 = PQCLEAN_NAMESPACE_gf16mat_gauss_elim(aa, H, 2 * H);  /// XXX: would 2*H fail if H is odd ???
...
void PQCLEAN_NAMESPACE_gf256mat_mul(uint8_t *c, const uint8_t *a, const uint8_t *b, unsigned len_vec) {
...
unsigned gf256mat_solve_linear_eq_ref( uint8_t *sol, const uint8_t *inp_mat, const uint8_t *c_terms, unsigned n ) {
    ...
    unsigned r8 = PQCLEAN_NAMESPACE_gf256mat_gauss_elim( mat, n, n + 1 );
    for (unsigned i = 0; i < n; i++) {
        sol[i] = mat[i * (n + 1) + n];
    }
    return r8;
...
unsigned PQCLEAN_NAMESPACE_gf256mat_inv( uint8_t *inv_a, const uint8_t *a, unsigned H, uint8_t *buffer ) {
    ...
    unsigned r8 = PQCLEAN_NAMESPACE_gf256mat_gauss_elim( aa, H, 2 * H );
...
void PQCLEAN_NAMESPACE_gf16mat_prod(uint8_t *c, const uint8_t *matA, unsigned n_A_vec_byte, unsigned n_A_width, const uint8_t *b) {
    gf16mat_prod_impl( c, matA, n_A_vec_byte, n_A_width, b);
}


unsigned PQCLEAN_NAMESPACE_gf16mat_gauss_elim(uint8_t *mat, unsigned h, unsigned w) {
    return gf16mat_gauss_elim_impl( mat, h, w);
}

unsigned PQCLEAN_NAMESPACE_gf16mat_solve_linear_eq( uint8_t *sol, const uint8_t *inp_mat, const uint8_t *c_terms, unsigned n ) {
...
void PQCLEAN_NAMESPACE_gf256mat_prod(uint8_t *c, const uint8_t *matA, unsigned n_A_vec_byte, unsigned n_A_width, const uint8_t *b) {
    gf256mat_prod_impl( c, matA, n_A_vec_byte, n_A_width, b);
}

unsigned PQCLEAN_NAMESPACE_gf256mat_gauss_elim( uint8_t *mat, unsigned h, unsigned w ) {
    return gf256mat_gauss_elim_impl( mat, h, w );
}


unsigned PQCLEAN_NAMESPACE_gf256mat_solve_linear_eq( uint8_t *sol, const uint8_t *inp_mat, const uint8_t *c_terms, unsigned n ) {
