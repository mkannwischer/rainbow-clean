...
uint8_t PQCLEAN_NAMESPACE_gf16_inv(uint8_t a) {
    ...
    uint8_t a6 = PQCLEAN_NAMESPACE_gf16_mul(a4, a2);
    return PQCLEAN_NAMESPACE_gf16_mul(a8, a6);
}
...
static inline uint8_t gf256_mul(uint8_t a, uint8_t b) {
    ...
    uint8_t b0 = b & 15;
    uint8_t b1 = (b >> 4);
    uint8_t a0b0 = PQCLEAN_NAMESPACE_gf16_mul(a0, b0);
    uint8_t a1b1 = PQCLEAN_NAMESPACE_gf16_mul(a1, b1);
    uint8_t a0b1_a1b0 = PQCLEAN_NAMESPACE_gf16_mul(a0 ^ a1, b0 ^ b1) ^ a0b0 ^ a1b1;
